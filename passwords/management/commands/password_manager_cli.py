...
class Command(BaseCommand):
    ...
    def show_main_menu(self):
        ...
        while True:
            ...
            self.stdout.write('3. 👁️  Ver contraseña específica')
            self.stdout.write('4. 🗑️  Eliminar contraseña')
    ...
    def view_password(self):
        ...
        self.stdout.write('\n👁️  SELECCIONAR CONTRASEÑA PARA VER:')
    ...
    def delete_password(self):
        ...
        self.stdout.write('\n🗑️  SELECCIONAR CONTRASEÑA PARA ELIMINAR:')
        ...
        try:
            ...
            if 0 <= choice < len(passwords):
                ...
                confirm = input(f'⚠️  ¿Eliminar "{password_entry.website}"? (s/N): ').lower()
                if confirm == 's':
